...
- (void)setIndicatorViewColor:(UIColor *)indicatorViewColor
{
    ...
    for (UIButton *btn in self.buttonArray) {
        if (self.currentBtn != btn) {
            [btn setTitleColor:self.indicatorColor forState:UIControlStateNormal];
            [btn setTitleColor:self.indicatorColor forState:UIControlStateHighlighted];
        }
    }
}
...
- (void)selecteBegan{
    ...
    [self.currentBtn setTitleColor:self.indicatorColor forState:UIControlStateNormal];
}
